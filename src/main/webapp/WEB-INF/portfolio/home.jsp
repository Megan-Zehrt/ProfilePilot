...
<body id="HomeBody">
		...
		<div class="dropdown-content">
			<div class="flex">
				<a class="dropdownlinks" href="/profile/pilot/portfolio/new">Create
					...
					<a class="dropdownlinks" href="/profile/pilot/portfolio/other/users">Others
	...
	<div class="Home-Flex">
		<div class="Home-Left-Div">
			<h1 class="Home-Header">ProfilePilot</h1>
			<p class="Home-Paragraph">Welcome to Your Portfolio Creator, where we turn your
		...
		<div>
			<a href="/profile/pilot/portfolio/new"><button class="btn btn-primary Home-Get-Started"><p class="Get-Started-BTN">Get Started</p></button></a>
		</div>
	</div>
